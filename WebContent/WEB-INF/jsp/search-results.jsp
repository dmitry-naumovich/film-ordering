    ...
    <div class="row content ">
      ...
      <div class="col-md-8 main content ">
        <div class="panel panel-primary">
          ...
          <h2 class=" text-left" style="margin:0px; padding:0px;"> Возможно, вы искали</h2>
          </div> 
          <div class="row panel-body">
            <div class="col-md-12">
                    ...
                    <thead>
                      ...
                      <tr>
                      <td><a href="../pages/order.html" class="btn btn-primary" role="button">Купить в один клик</a> </td>
