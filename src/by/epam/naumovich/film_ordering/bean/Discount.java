...
public class Discount {
	...
	public boolean equals(Object obj) {
		...
		if (userID != discount.userID) { return false; }
	...
	public int hashCode() {
		int hash = 3;
	    hash = 7 * hash + this.id;
	    hash = 1 * hash + this.userID;
	    hash = 13 * hash + this.amount;
	    hash = 17 * hash + ((null != this.stDate) ? this.stDate.hashCode() : 0);
	    hash = 19 * hash + ((null != this.stTime) ? this.stTime.hashCode() : 0);
	    hash = 31 * hash + ((null != this.enDate) ? this.enDate.hashCode() : 0);
	    hash = 47 * hash + ((null != this.enTime) ? this.enTime.hashCode() : 0);
	    return hash;
	}
	@Override
